...
class ValueException extends Exception {
	...
	public function __construct ($value, $previous = null, $native = null) {
		#/home/tjpalmer/apps/haxe-4.1.2/std/haxe/ValueException.hx:24: characters 3-100
		parent::__construct(\Std::string($value), $previous, $native);
		#/home/tjpalmer/apps/haxe-4.1.2/std/haxe/ValueException.hx:25: characters 3-21
		$this->value = $value;
	}
}
